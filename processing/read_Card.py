from processing.card_classifier import *
from processing.read_number import *
import os
import numpy as np
...
### TODO Maybe delete images once processed so future imports of images don't continually stack up and repeat
...
def read_card():
    # Dictionary of processed info. Key = auto incremented index. 
    new_data = {}
    key_num = 0
